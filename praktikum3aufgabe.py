...
def get_led_state(celsius):
    """
    Gibt anhand der Temperatur in Grad Celsius (celsius) den passenden
    LED-Zustand zurück (ROT, GELB, GRUEN oder AUS).
    """
...
def celsius_zu_fahrenheit(celsius):
    """
    Rechnet eine Temperatur von Grad Celsius in Grad Fahrenheit um.
    """
    # TODO: eigenen Code hier einfügen
    pass
...
def celsius_zu_kelvin(celsius):
    """
    Rechnet eine Temperatur von Grad Celsius in Kelvin um.
    """
    # TODO: eigenen Code hier einfügen
    pass
...
def spannung_zu_temperatur(spannung):
    """
    Rechnet die vom AD8495-Verstärker gemessene Spannung (in Volt)
    in eine Temperatur in Grad Celsius um.
    """
    # TODO: eigenen Code hier einfügen
    pass
...
def update(frame):
    ...
    # TODO: Berechne aus der gemessenen Spannung (spannung) die
    # Temperatur in Grad Celsius, Fahrenheit und Kelvin
    celsius    = None  # TODO: ersetzen
    fahrenheit = None  # TODO: ersetzen
    kelvin     = None  # TODO: ersetzen
    ...
    # TODO: Füge den neuen Messwert (spannung) am Ende der Liste
    # "volt_data" hinzu und entferne dafür den ältesten Wert (Index 0),
    # damit die Liste immer genau N_SAMPLES Einträge behält
    ...
    # TODO: Rufe get_led_state(celsius) auf, um den passenden
    # LED-Zustand zu bestimmen, und schreibe ihn mit do_task.write(...)
    # an die LEDs.
